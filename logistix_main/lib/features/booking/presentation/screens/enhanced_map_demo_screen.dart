...
class EnhancedMapDemoScreen extends StatefulWidget {
  const EnhancedMapDemoScreen({Key? key}) : super(key: key);

  @override
  State<EnhancedMapDemoScreen> createState() => _EnhancedMapDemoScreenState();
}

class _EnhancedMapDemoScreenState extends State<EnhancedMapDemoScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: Icon(
              _enableSearch ? Icons.search : Icons.search_off,
              color: Colors.black,
            ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Lag-free with search functionality',
